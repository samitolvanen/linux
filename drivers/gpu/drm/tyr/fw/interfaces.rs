...
//! Shared CSF firmware interface definitions and low-level access helpers.
//!
...
// programming (`Scheduler::program_csg_activate`) and per-tick CSG_REQ
...
mod iface {
    ...
    /// is a multiple of 4.
    pub(in crate::fw) struct FwInterface<T: ?Sized> {
    ...
    // A derive would bound `T: Clone`, which the unsized base types cannot satisfy.
    impl<T: ?Sized> Clone for FwInterface<T> {
        fn clone(&self) -> Self {
            Self {
...
mod glb {
    ...
    pub(super) mod control {
        use super::GLB_CONTROL_BLOCK_SIZE;
        use kernel::{
            io::Region,
            register, //
        };
        ...
        register! {
            base: Region<GLB_CONTROL_BLOCK_SIZE>;
    ...
    pub(super) mod output {
        ...
        register! {
            base: Region<GLB_OUTPUT_BLOCK_SIZE>;
...
mod csg {
    ...
    pub(super) mod control {
        use super::CSG_CONTROL_BLOCK_SIZE;
        use kernel::{
            io::Region,
            register, //
        };
        ...
        register! {
            base: Region<CSG_CONTROL_BLOCK_SIZE>;
    ...
    pub(super) mod output {
        ...
        register! {
            base: Region<CSG_OUTPUT_BLOCK_SIZE>;
...
pub(super) mod cs {
    ...
    pub(super) enum CsFatalExceptionType {
        ...
        CsConfigFault = 0x40,
        /// Command stream marked as unrecoverable. The firmware will not resume it.
    ...
    pub(super) mod control {
        use super::CS_CONTROL_BLOCK_SIZE;
        use kernel::{
            io::Region,
            register, //
        };
        ...
        register! {
            base: Region<CS_CONTROL_BLOCK_SIZE>;
