...
pub(crate) type PageTable<'a> = IoPageTable<'a, ARM64LPAES1, PtAllocator>;

/// A device-managed `PageTable`.
pub(crate) type DevresPageTable = DevresIoPageTable<ARM64LPAES1, PtAllocator>;
