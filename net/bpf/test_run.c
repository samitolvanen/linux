...
__bpf_kfunc void bpf_kfunc_call_memb_release(void *p)
{
}

<<<<<<< HEAD
=======
__bpf_kfunc void bpf_kfunc_call_memb1_release(void *p)
{
	WARN_ON_ONCE(1);
}
...
>>>>>>> b5cd0c45bb6c (bpf, test_run: Fix _release type mismatches)
__diag_pop();
